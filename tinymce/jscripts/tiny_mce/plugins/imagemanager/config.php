...
$fileToInclude = dirname(__FILE__)."/../../../../ke-location.php";
//trigger_error($fileToInclude, E_USER_ERROR);
...
/*************************************************************************************************/
	...
	$mcImageManagerConfig['filesystem.rootpath'] = $pluginLocation.'/uploads/'; // absolute or relative from this script path, required. // bmb
