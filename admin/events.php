...
$page_url = $theAdminURL."/admin.php?page=".$pluginDirname."/admin/events.php";
?>
<div class="wrap">
	<h2>Events</h2>
	<?php
			...
			*********************/
			...
			<form id="feeds-form" method="post" action="<?php print $page_url."&action=".$_GET['action']."&itemID=".$_GET['itemID']; ?>">
				...
				tinyMCE.init({
					...
					// bmb -- changed from a hardcoded Kino URL					
					document_base_url : "<?php global $pluginRelativeLocation; echo $pluginRelativeLocation; ?>/"
