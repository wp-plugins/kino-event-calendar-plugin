...
.fc-event a {
	border-style: solid; 
	border-color: <?php print $setting_event_colour; ?>;
	background-color: <?php print $setting_event_colour; ?>;
	color: #333;  
	}
...
.fc-event-selected a {
	border-style: solid; 
	border-color: <?php print $setting_event_colour_hover; ?>;     /* default BORDER color (probably the same as background-color) */
	background-color: <?php print $setting_event_colour_hover; ?>; /* default BACKGROUND color */
	color: <?php print $setting_event_colour_hover; ?>;            /* default TEXT color */
	}
...
.fc-event a {
	...
	cursor: pointer;
	color: <?php print $setting_event_colour; ?>;
	}
	
.fc-event a:hover {
	background-color: <?php print $setting_event_colour_hover; ?>;
}
